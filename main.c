/*
https://github.com/wres168/Linear-Discriminant-Analysis-in-C
*/
...
int m_add(double**,double**,double**,matrix_s,matrix_s,matrix_s);
int m_sub(double**,double**,double**,matrix_s,matrix_s,matrix_s);
int m_mul(double**,double**,double**,matrix_s,matrix_s,matrix_s);
int m_inv(double**,double**,matrix_s,matrix_s);
int m_clr(double**,matrix_s);
int m_cpy(double**,double**,matrix_s,matrix_s);
int m_init(double ***,matrix_s);
int m_free(double ***,matrix_s);
int m_print(double**,matrix_s);
int m_qr(double**,double**,double**,matrix_s,matrix_s,matrix_s);
int eig_val_sort(double**,matrix_s,int);
int eigVector(double**,double**,double**,matrix_s,matrix_s,matrix_s);
int Eig(double**,double**,double**,matrix_s,matrix_s,matrix_s,int);

int  main(int argc,char** argv){
    FILE* pFile=fopen("test_data.out","r");
    if (pFile==NULL){
        printf("找不到 test_data.out");
        return -1;
    }
    FILE* plable=fopen("test_lable.out","r");
    if (pFile==NULL){
        printf("找不到 test_lable.out");
        return -1;
    }
    int n,m,n_l;
    n=0;
    ...
    /*double **data = (double **) malloc(m * sizeof(double *)); //r
    for (int i=0;i<m;i++)
        data[i]=(double *) malloc(n*sizeof(double)); //c
    if (data==NULL){
        printf("malloc 失敗");
        return -1;
    }*/
    ...
    /*double **mean_v = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        mean_v[i]=(double *) malloc(1*sizeof(double));
    if (mean_v==NULL){
    ...
    /*double **mean_class_v = (double **) malloc(m * sizeof(double *));
    for (int i=0;i<m;i++)
        mean_class_v[i]=(double *) malloc(l_count*sizeof(double));
    ...
    /*double **col_v = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        col_v[i]=(double *) malloc(1*sizeof(double));
    if (col_v==NULL){
    ...
    /*double **row_v = (double **) malloc(1 * sizeof(double*));
    for (int i=0;i<m;i++)
        row_v[i]=(double *) malloc(m*sizeof(double));
    if (row_v==NULL){
    ...
    /*double **sw = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        sw[i]=(double *) malloc(m*sizeof(double));
    if (sw==NULL){
        printf("malloc sw 失敗");
        return -1;
    }*/
    ...
    /*double **sk = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        sk[i]=(double *) malloc(m*sizeof(double));
    if (sk==NULL){
        printf("malloc sk 失敗");
        return -1;
    }*/
    ...
    /*double **sb = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        sb[i]=(double *) malloc(m*sizeof(double));
    if (sb==NULL){
        printf("malloc sb 失敗");
        return -1;
    }*/
    ...
    /*double **inv_sw = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        inv_sw[i]=(double *) malloc(m*sizeof(double));
    if (inv_sw==NULL){
    ...
    /*double **ss = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        ss[i]=(double *) malloc(m*sizeof(double));
    if (ss==NULL){
        printf("malloc ss 失敗");
        return -1;
    }*/
    ...
    /*double **sw_t = (double **) malloc(m * sizeof(double*));
    for (int i=0;i<m;i++)
        sw_t[i]=(double *) malloc(m*sizeof(double));
    if (sw_t==NULL){
        printf("malloc ss 失敗");
        return -1;
    }*/
...
int m_add(double** a,double** b,double** c,matrix_s a_s,matrix_s b_s,matrix_s c_s){  //c=a+b
    int m=a_s.row;
    //printf("m=%d\n",m);
...
int m_sub(double** a,double** b,double** c,matrix_s a_s,matrix_s b_s,matrix_s c_s){  //c=a-b
    int m=a_s.row;
    printf("m=%d\n",m);
    if(m != b_s.row || m != c_s.row){
        printf("size error");
...
int m_mul(double** a,double** b,double** c,matrix_s a_s,matrix_s b_s,matrix_s c_s){  //c=a*b
...
int m_clr(double** a,matrix_s a_s){    //a=zeros;
    for (int i=0;i<a_s.row;i++){
...
int m_cpy(double** a,double** b,matrix_s a_s,matrix_s b_s){    //b=a;
    if(a_s.col != b_s.col ){
        printf("size error");
        return -1;
    }
...
int m_inv(double** a,double** b,matrix_s a_s,matrix_s b_s){  //b=a^-1
...
int m_init(double *** a,matrix_s a_s){
    double **t = (double **) malloc(a_s.row * sizeof(double *)); //r
    for (int i=0;i<a_s.row;i++)
        t[i]=(double *) malloc(a_s.col * sizeof(double)); //c
    if (t==NULL){
        printf("malloc 失敗");
        return -1;
    }
...
int m_free(double *** a,matrix_s a_s){
    double **t=*a;
    for(int i=0;i<a_s.row;i++)
        free(t[i]);
    free(t);
...
int m_print(double** a,matrix_s a_s){
	for (int i = 0; i < a_s.row; i++){
        for (int j = 0; j < a_s.col; j++){
            printf("%12.4g  ", a[i][j]);
        }
...
double m_norm2(double** a,matrix_s a_s){
...
輸出：無
************************************************************************/
int m_qr(double** a,double** q,double** r,matrix_s a_s,matrix_s q_s,matrix_s r_s){
    double** col_A,** col_Q;
    ...
    for(int j=0;j<a_s.col;j++){
        ...
        double temp = m_norm2(col_Q,col_Q_s);
        r[j][j] = temp;
...
************************************************************************/
int eig_val_sort(double** a,matrix_s a_s,int flag){
    for(int i=0;i<a_s.row;i++){
        int k=i;
        for(int j=i+1;j<a_s.row;j++){
            if(flag==1){
...
int Eig(double** a,double** evec,double** eval,matrix_s a_s,matrix_s evec_s,matrix_s eval_s,int NUM){
    double** temp;
